  ...
  return (
    <div className="companion">
      ...
      <p className="companion-body">
        Want your wallpaper to update itself automatically — no manual downloads,
        ever? Install the companion app and it'll run quietly in the background,
        regenerating and setting your actual desktop wallpaper on the schedule
        you picked above.
      </p>
      <div className="companion-btns">
        ...
        <span className="companion-btn companion-btn-disabled" title="Mac support isn't available yet">
      ...
      <p className="companion-note">
        Your user ID is saved inside the installer — no extra setup needed.
        Prefer to set your wallpaper manually instead? You can always download
        a one-off copy from the button above the grid.
      </p>
    </div>
  );
}